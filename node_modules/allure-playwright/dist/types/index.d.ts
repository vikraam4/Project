...
export declare class AllureReporter implements ReporterV2 {
    ...
    private pendingAttachmentTasks;
    private readonly attachmentTargetByStep;
    ...
    private queueAttachmentTask;
    private flushAttachmentTasks;
    private recordAttachmentTarget;
    private getHookStepsStack;
    private removeHookAttachmentPlaceholder;
    private addAttachmentToHookStep;
    private addRuntimeAttachmentToHookStack;
    private processHookRuntimeMessage;
    private shouldProcessAttachmentAtTestEnd;
    private processStepEndAttachments;
    ...
    private isEmptyPassedHookRoot;
    private pruneEmptyHookRoots;
    private removeStepFromHookStack;
